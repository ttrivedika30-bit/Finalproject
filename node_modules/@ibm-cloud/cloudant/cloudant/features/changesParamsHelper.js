...
exports.ChangesParamsHelper = exports.Mode = void 0;
...
class ChangesParamsHelper {
    ...
    static cloneParams(params, mode, since, limit) {
        const clonedParams = {
            db: params.db,
        ...
        if (mode === Mode.FINITE) {
            clonedParams.feed = v1_1.PostChangesConstants.Feed.NORMAL;
        }
        else if (mode === Mode.LISTEN) {
            clonedParams.feed = v1_1.PostChangesConstants.Feed.LONGPOLL;

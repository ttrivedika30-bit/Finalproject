 ...
 */
export declare function errorResponseInterceptor(axiosError: any): Promise<never>;
/**
 ...
 */
export declare function errorResponseStreamConverter(axiosError: any): Promise<never>;
